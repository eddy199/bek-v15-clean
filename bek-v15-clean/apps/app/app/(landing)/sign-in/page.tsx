...
async function SignIn({
	...
	// ── FIX : Appels séquentiels avec try/catch natifs ──
	// Promise.all + .catch() + unstable_rethrow = crash si Prisma/Neon timeout
	// On sépare les appels pour isoler les erreurs sans tuer le processus.
	...
	let options: SignInOptions | null = null;
	try {
