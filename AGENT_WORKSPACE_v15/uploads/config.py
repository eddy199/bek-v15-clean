...
for key, val in ENV.items():
    if key.startswith("meta/") or key.startswith("nvidia/") or key.startswith("openai/") or key.startswith("mistralai/") or key.startswith("google/") or key.startswith("nv-") or key in ["paligemma", "esm2-650m", "esmfold", "riva-translate-4b-instruct-v1", "Background-Noise-Removal", "Studio-Voice", "llama-3.1-nemotron-safety-guard-8b-v3", "solar-10.7b-instruct", "Bevformer", "Sparsedrive"]:
