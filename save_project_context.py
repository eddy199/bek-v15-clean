...
MEMORY_FILE = ROOT / "PROJECT_BRAIN.md"
...
MEMORY_FILE.write_text(PROJECT_CONTEXT, encoding="utf-8")
print("✅ Contexte permanent sauvegardé avec succès dans PROJECT_BRAIN.md !")